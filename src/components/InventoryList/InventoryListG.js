...
function InventoryList({ setInventoryToEdit, setEditCount, editCount }) {
  ...
  console.log("this is the inventories list", inventories);
  ...
  console.log("this is the filtered inventories", filteredInventories);

  console.log("this is the search inventory item", searchInventoryItem);
              ...
              {filteredInventories.map((inventory) => (
                <tr className="inventories__lists-row">
                  <td className="inventories__lists-cell inventories__lists--text-underline">
                    <h4 className="inventories__lists-title">INVENTORY ITEM</h4>
                    {/* <br /> */}
                    <Link
                      // key={inventory.id}
                      className="link"
                  ...
                  <td className="inventories__lists-cell">
                    <h4 className="inventories__lists-title">CATEGORY</h4>
                    <br />
                    <p>{inventory.category}</p>
                  </td>
                  <td className="inventories__lists-cell">
                    <h4 className="inventories__lists-title">STATUS</h4>
                    <br />
                    <p
                      id={`${
                        inventory.quantity > 0 ? "instock" : "outofstock"
                      }`}
                    >
                      {inventory.status}
                    </p>
                  ...
                  <td className="inventories__lists-cell">
                    <h4 className="inventories__lists-title">QTY</h4>
                    <br />
                    <p>{inventory.quantity}</p>
                  </td>
                  <td className="inventories__lists-cell">
                    <h4 className="inventories__lists-title">WAREHOUSE</h4>
                    <br />
