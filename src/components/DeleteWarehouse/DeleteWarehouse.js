...
function DeleteWarehouse({ onclose, warehouseToDelete }) {
    ...
    return (
        <div className="delete-container">
            ...
            <h2 className="delete-container__title">Delete {warehouseToDelete.warehouse_name} warehouse?</h2>
            <p className="delete-container__text">Please confirm that you'd like to delete the {warehouseToDelete.warehouse_name}  from the list of warehouses. You won't be able to undo this action</p>
